                ...
                <li class="tickets-list__item">
                    <div class="ticket-card ticket-card--color01">
                        <div class="ticket-card__img">
                            <?= Html::img($offer->images[0]->url, ['srcset' => $offer->images[0]->url . ' 2x', 'alt' => 'Изображение товара']) ?>
                        </div>
                        <div class="ticket-card__info">
                            ...
                            <div class="ticket-card__header">
                                <h3 class="ticket-card__title"><?= Html::a(Html::encode($offer->title), ['offers/view', 'id' => $offer->id]) ?></h3>
